<x-app-layout>
    ...
    <div class="py-8 bg-slate-100 min-h-screen">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <!-- FORM CONTAINER PRESISI FIGMA F.1-25 -->
            <form action="{{ route('surat.f125.store') }}" method="POST" id="formF125" x-data="f125Form()" class="bg-white shadow-xl rounded-2xl border border-slate-200 overflow-hidden">
                @csrf
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nomor_surat" value="{{ old('nomor_surat', $nomorSuratDefault ?? '') }}" 
                               ...
                               placeholder="Contoh: 475/LMG-F125/IX/001/2026">
                    </div>
                    ...
                    <!-- SUB-TITLE JUDUL DOKUMEN F.1-25 -->
                    <div class="py-4 border-y-2 border-slate-800 text-center space-y-1 my-6 bg-slate-50 rounded-xl">
                        ...
                        <p class="text-xs sm:text-sm font-bold text-slate-700">
                            Antar Desa/Kelurahan Dalam Satu Kecamatan (Kode: F.1-25)
                        </p>
                    </div>
                    ...
                    <div class="space-y-5 pt-4 border-t-2 border-slate-300">
                        ...
                        <div class="space-y-3 bg-slate-50 p-4 rounded-xl border border-slate-200 text-xs">
                            <label class="block font-extrabold text-slate-800">2. Alamat Tujuan Pindah Lengkap (Antar Desa Dalam Kec. Bunut)</label>
                            
                            <div>
                                <textarea name="alamat_tujuan" rows="2" placeholder="Alamat Tujuan Pindah (Jalan / Dusun Desa Tujuan)..." class="w-full px-3.5 py-2 rounded-xl border border-slate-300 focus:border-[#235832] font-semibold uppercase"></textarea>
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="dusun_tujuan" placeholder="Contoh: Dusun II Balam Jaya" class="w-full px-3 py-1.5 rounded-lg border border-slate-300 font-semibold uppercase">
                                </div>
                                <div>
                                    <label class="block font-bold text-slate-700 mb-1">Desa / Kelurahan Tujuan</label>
                                    <input type="text" name="desa_tujuan" placeholder="Contoh: Balam Jaya" class="w-full px-3 py-1.5 rounded-lg border border-slate-300 font-semibold uppercase">
                                </div>
                                <div>
                                    <label class="block font-bold text-slate-700 mb-1">Kecamatan Tujuan</label>
                                    <input type="text" name="kec_tujuan" value="BUNUT" class="w-full px-3 py-1.5 rounded-lg border border-slate-300 font-semibold uppercase">
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="kodepos_tujuan" maxlength="5" value="28382" class="w-full px-3 py-1.5 rounded-lg border border-slate-300 text-center font-mono font-bold">
                                </div>
                                <div class="sm:col-span-2">
                    ...
                    <div class="pt-6 border-t-2 border-slate-200 flex justify-center">
                        <button type="submit" class="w-full sm:w-auto px-8 py-3.5 bg-[#0284c7] hover:bg-[#0369a1] text-white font-black text-sm tracking-wider uppercase rounded-2xl shadow-lg hover:shadow-xl transition-all flex items-center justify-center space-x-2">
                            <span>SIMPAN KE ARSIP & CETAK DOKUMEN F.1-25</span>
                        </button>
                    </div>
