...
<head>
    ...
    <title>Informasi Dokumen & Persyaratan Layanan - Desa Lubuk Mandian Gajah</title>
...
<body class="antialiased min-h-screen bg-slate-100 flex flex-col items-center justify-start py-0 sm:py-6 px-0 sm:px-4 lg:px-8">
    ...
    <div class="w-full max-w-md lg:max-w-7xl mx-auto bg-white min-h-screen sm:min-h-0 sm:rounded-2xl lg:rounded-3xl sm:shadow-xl lg:shadow-2xl overflow-hidden relative pb-20 lg:pb-0 border border-slate-200/60">
        ...
        <!-- HERO / BANNER DOKUMEN (Sesuai Screenshot Figma iPhone 16 - 10) -->
        <section class="relative bg-slate-900 text-white">
            <div class="h-52 sm:h-64 lg:h-72 w-full relative overflow-hidden">
                <img src="{{ asset('images/kantor-desa.png') }}" alt="Banner Dokumen Kantor Desa" class="w-full h-full object-cover">
                <div class="absolute inset-0 bg-gradient-to-t from-black/85 via-black/50 to-black/30"></div>
            </div>
            
            <!-- Hero Content Overlay: Icon + Text -->
            <div class="absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                <!-- Large Document Icon SVG inside container -->
                <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-white/15 backdrop-blur-md border border-white/30 flex items-center justify-center mb-3 shadow-lg">
                ...
                <p class="text-xs sm:text-sm uppercase tracking-widest text-emerald-300 font-bold mb-1">
                    Info Dokumen
                </p>
                <h2 class="text-base sm:text-2xl lg:text-3xl font-extrabold text-white leading-tight tracking-tight max-w-xl">
                    Desa Lubuk Mandian Gajah<br>
                    <span class="text-slate-200 text-xs sm:text-base font-medium">Kecamatan Bunut, Kabupaten Pelalawan</span>
                </h2>
            </div>
        </section>

        <!-- PAGE HEADER TITLE & BREADCRUMB -->
        <div class="px-4 sm:px-6 lg:px-8 pt-6 sm:pt-8 max-w-4xl mx-auto">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200/80 pb-5">
                <div>
                    <div class="flex items-center space-x-2 text-xs font-semibold text-emerald-700 uppercase tracking-wider mb-1">
                        ...
                        <span class="text-[#235832]">Dokumen Publik</span>
                    </div>
        ...
        <!-- KARTU PPID (Desain mengapung / Card di bawah Banner sesuai Figma) -->
        <section class="px-4 sm:px-6 lg:px-8 mt-6 relative z-20 mb-6">
            <div class="max-w-xl lg:max-w-2xl mx-auto bg-white p-4 sm:p-5 rounded-2xl border border-slate-200/90 shadow-lg flex items-center space-x-4">
                <!-- Icon Clock / Document -->
                <div class="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-emerald-50 text-[#235832] border border-emerald-100 flex items-center justify-center shrink-0 shadow-inner">
                ...
                <div>
                    <h3 class="text-base sm:text-lg font-black text-[#235832] tracking-tight">PPID</h3>
                    <p class="text-xs sm:text-sm font-semibold text-slate-700">Informasi Dokumen Setiap Saat</p>
                </div>
            </div>
        </section>

        <!-- DAFTAR ACCORDION PERSYARATAN DOKUMEN (Menggunakan Alpine.js) -->
        <section class="px-4 sm:px-6 lg:px-8 pb-8" x-data="{ openAccordion: 1 }">
            <div class="max-w-3xl mx-auto space-y-4">

                <div class="mb-2">
                    <h3 class="text-xs font-bold text-slate-500 uppercase tracking-wider">Layanan Administrasi</h3>
                    <h2 class="text-lg sm:text-xl font-extrabold text-slate-900">Persyaratan Pengurusan Dokumen</h2>
                </div>

                <!-- ACCORDION 1: Persyaratan Pindah Domisili -->
                <div class="bg-white rounded-2xl border border-slate-200/90 shadow-sm overflow-hidden transition-all">
                    <button 
                        ...
                        class="w-full px-5 py-4 flex items-center justify-between text-left font-extrabold text-xs sm:text-sm text-slate-800 hover:bg-slate-50 transition-colors"
                    >
                        <span class="flex items-center space-x-3">
                            <span class="w-2.5 h-2.5 rounded-full bg-[#235832]"></span>
                            <span>Persyaratan Pindah Domisili</span>
                        </span>
                        <svg class="w-4 h-4 text-slate-400 transition-transform duration-200" :class="{ 'rotate-180': openAccordion === 1 }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </button>
                    
                    <div x-show="openAccordion === 1" x-collapse x-cloak class="px-5 pb-5 pt-2 text-xs sm:text-sm text-slate-700 border-t border-slate-100 bg-slate-50/50">
                        <ul class="space-y-2.5 font-medium">
                            <li class="flex items-start space-x-2.5">
                                <span class="w-1.5 h-1.5 rounded-full bg-emerald-600 mt-2 shrink-0"></span>
                                <span>KTP el (Asli dan Fotocopy)</span>
                            </li>
                            <li class="flex items-start space-x-2.5">
                                <span class="w-1.5 h-1.5 rounded-full bg-emerald-600 mt-2 shrink-0"></span>
                            ...
                            <li class="flex items-start space-x-2.5">
                                <span class="w-1.5 h-1.5 rounded-full bg-emerald-600 mt-2 shrink-0"></span>
                                <span>Surat nikah atau akta cerai</span>
                            </li>
                            <li class="flex items-start space-x-2.5">
                                <span class="w-1.5 h-1.5 rounded-full bg-emerald-600 mt-2 shrink-0"></span>
                                <span>Surat pernyataan tidak keberatan dari pemilik rumah</span>
                            </li>
                        </ul>
                    </div>
                </div>

                <!-- ACCORDION 2: Persyaratan Pindah KK -->
                <div class="bg-white rounded-2xl border border-slate-200/90 shadow-sm overflow-hidden transition-all">
                    <button 
                    ...
                    >
                        <span class="flex items-center space-x-3">
                            <span class="w-2.5 h-2.5 rounded-full bg-[#235832]"></span>
                            <span>Persyaratan Pindah KK</span>
                        </span>
                        <svg class="w-4 h-4 text-slate-400 transition-transform duration-200" :class="{ 'rotate-180': openAccordion === 2 }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </button>

                    <div x-show="openAccordion === 2" x-collapse x-cloak class="px-5 pb-5 pt-2 text-xs sm:text-sm text-slate-700 border-t border-slate-100 bg-slate-50/50">
                        <ul class="space-y-2.5 font-medium">
                            <li class="flex items-start space-x-2.5">
                                <span class="w-1.5 h-1.5 rounded-full bg-emerald-600 mt-2 shrink-0"></span>
                                <span>Kartu Keluarga (KK) Lama (Asli & Fotocopy)</span>
                            </li>
                            <li class="flex items-start space-x-2.5">
                                <span class="w-1.5 h-1.5 rounded-full bg-emerald-600 mt-2 shrink-0"></span>
                                <span>KTP-el Pemohon / Kepala Keluarga</span>
                            </li>
                            <li class="flex items-start space-x-2.5">
                                <span class="w-1.5 h-1.5 rounded-full bg-emerald-600 mt-2 shrink-0"></span>
                                <span>Surat Pengantar dari RT/RW & Kantor Desa Lubuk Mandian Gajah</span>
                            </li>
                            <li class="flex items-start space-x-2.5">
                                <span class="w-1.5 h-1.5 rounded-full bg-emerald-600 mt-2 shrink-0"></span>
                                <span>Buku Nikah / Akta Perceraian (jika ada perubahan status perkawinan)</span>
                            </li>
                            <li class="flex items-start space-x-2.5">
                                <span class="w-1.5 h-1.5 rounded-full bg-emerald-600 mt-2 shrink-0"></span>
                                <span>Alamat lengkap tujuan pemindahan Kartu Keluarga</span>
                            </li>
                        </ul>
                    </div>
                </div>

                <!-- ACCORDION 3: Persyaratan Buat Akta -->
                <div class="bg-white rounded-2xl border border-slate-200/90 shadow-sm overflow-hidden transition-all">
                    <button 
                    ...
                    >
                        <span class="flex items-center space-x-3">
                            <span class="w-2.5 h-2.5 rounded-full bg-[#235832]"></span>
                            <span>Persyaratan Buat Akta</span>
                        </span>
                        <svg class="w-4 h-4 text-slate-400 transition-transform duration-200" :class="{ 'rotate-180': openAccordion === 3 }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </button>

                    <div x-show="openAccordion === 3" x-collapse x-cloak class="px-5 pb-5 pt-2 text-xs sm:text-sm text-slate-700 border-t border-slate-100 bg-slate-50/50">
                        <ul class="space-y-2.5 font-medium">
                            <li class="flex items-start space-x-2.5">
                                <span class="w-1.5 h-1.5 rounded-full bg-emerald-600 mt-2 shrink-0"></span>
                                <span>Surat Keterangan Lahir / Kematian Asli dari Bidan, Dokter, atau Kepala Desa</span>
                            </li>
                            <li class="flex items-start space-x-2.5">
                                <span class="w-1.5 h-1.5 rounded-full bg-emerald-600 mt-2 shrink-0"></span>
                                <span>Fotocopy Kartu Keluarga (KK) & KTP-el Orang Tua / Pelapor</span>
                            </li>
                            <li class="flex items-start space-x-2.5">
                                <span class="w-1.5 h-1.5 rounded-full bg-emerald-600 mt-2 shrink-0"></span>
                                <span>Fotocopy Buku Nikah / Akta Perkawinan Orang Tua</span>
                            </li>
                            <li class="flex items-start space-x-2.5">
                                <span class="w-1.5 h-1.5 rounded-full bg-emerald-600 mt-2 shrink-0"></span>
                                <span>Fotocopy KTP-el 2 (dua) Orang Saksi</span>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <nav class="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-[#235832] text-white flex justify-around items-center py-2 px-3 border-t border-emerald-700/80 z-50 rounded-t-2xl shadow-2xl lg:hidden">
            ...
            <!-- 2. Dokumen / Berita (Active Page) -->
            <a href="{{ url('/dokumen') }}" class="flex flex-col items-center justify-center text-white py-1 px-4 rounded-xl bg-white/15 border border-white/20 transition-all">
                <svg class="w-5 h-5 mb-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                </svg>
                <span class="text-[11px] font-extrabold tracking-tight">Dokumen</span>
            </a>
