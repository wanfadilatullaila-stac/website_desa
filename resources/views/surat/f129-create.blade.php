<x-app-layout>
    ...
    <div class="py-8 bg-slate-100 min-h-screen">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <!-- FORM CONTAINER PRESISI FIGMA -->
            <form action="{{ route('surat.f129.store') }}" method="POST" x-data="f129Form()" class="bg-white shadow-xl rounded-2xl border border-slate-200 overflow-hidden">
                @csrf

                <!-- SEKSI HEADER DOKUMEN: ISI DATA -->
                <div class="bg-slate-200/90 py-3.5 px-6 border-b border-slate-300 text-center">
                    <h2 class="text-lg font-black text-slate-800 tracking-wider uppercase">ISI DATA</h2>
                </div>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <!-- SUB-TITLE JUDUL DOKUMEN F.1-29 -->
                    <div class="py-4 border-y-2 border-slate-800 text-center space-y-1 my-6 bg-slate-50 rounded-xl">
                        ...
                        <p class="text-xs sm:text-sm font-bold text-slate-700">
                            Antar Desa/Kelurahan Dalam Satu Kecamatan (Kode: F.1-29)
                        </p>
                    </div>
                    ...
                    <div class="space-y-5 pt-4 border-t-2 border-slate-300">
                        ...
                        <div class="space-y-3 bg-slate-50 p-4 rounded-xl border border-slate-200 text-xs">
                            <label class="block font-extrabold text-slate-800">2. Alamat Tujuan Pindah Lengkap</label>
                            
                            <div>
                                <textarea name="alamat_tujuan" rows="2" placeholder="Alamat Tujuan Pindah (Jalan / Perumahan)..." class="w-full px-3.5 py-2 rounded-xl border border-slate-300 focus:border-[#235832] font-semibold uppercase"></textarea>
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="dusun_tujuan" placeholder="Contoh: Dusun Makmur" class="w-full px-3 py-1.5 rounded-lg border border-slate-300 font-semibold uppercase">
                                </div>
                                <div>
                                    <label class="block font-bold text-slate-700 mb-1">Desa / Kelurahan Tujuan</label>
                                    <input type="text" name="desa_tujuan" placeholder="Contoh: Pangkalan Kerinci Kota" class="w-full px-3 py-1.5 rounded-lg border border-slate-300 font-semibold uppercase">
                                </div>
                                <div>
                                    <label class="block font-bold text-slate-700 mb-1">Kecamatan Tujuan</label>
                                    <input type="text" name="kec_tujuan" placeholder="Contoh: Pangkalan Kerinci" class="w-full px-3 py-1.5 rounded-lg border border-slate-300 font-semibold uppercase">
                                </div>
                                <div>
                                    <label class="block font-bold text-slate-700 mb-1">Kabupaten / Kota Tujuan</label>
                                    <input type="text" name="kab_tujuan" value="PELALAWAN" class="w-full px-3 py-1.5 rounded-lg border border-slate-300 font-semibold uppercase">
                                </div>
                                <div>
                                    <label class="block font-bold text-slate-700 mb-1">Provinsi Tujuan</label>
                                    <input type="text" name="prov_tujuan" value="RIAU" class="w-full px-3 py-1.5 rounded-lg border border-slate-300 font-semibold uppercase">
                                </div>
                                <div>
                                    <label class="block font-bold text-slate-700 mb-1">Kode Pos Tujuan (5 Digit)</label>
                                    <input type="text" name="kodepos_tujuan" maxlength="5" placeholder="28300" class="w-full px-3 py-1.5 rounded-lg border border-slate-300 text-center font-mono font-bold">
                                </div>
                                <div class="sm:col-span-2">
                    ...
                    <div class="pt-6 border-t-2 border-slate-200 flex justify-center">
                        <button type="submit" class="w-full sm:w-80 py-3.5 bg-[#0284c7] hover:bg-[#0369a1] text-white font-black text-sm tracking-widest uppercase rounded-2xl shadow-lg hover:shadow-xl transition-all flex items-center justify-center space-x-2">
                            <span>INPUT</span>
                        </button>
                    </div>
