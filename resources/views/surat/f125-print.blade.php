...
<head>
    ...
    <title>Formulir Pindah WNI F.1-25 - {{ $surat->nama_pemohon }}</title>
...
<body class="text-slate-900 font-sans text-xs" style="background-color: #f3f4f6; min-height: 100vh; padding: 20px 0;">
    ...
    <div class="no-print fixed top-4 right-4 z-50 flex items-center space-x-3 bg-white/90 backdrop-blur-md p-3 rounded-2xl shadow-2xl border border-slate-300">
        <a href="{{ route('surat.f125.create') }}" class="px-4 py-2 bg-slate-700 hover:bg-slate-800 text-white font-bold rounded-xl text-xs flex items-center space-x-1.5 transition-all">
    ...
    <div class="print-container space-y-1.5 text-[9.5px] leading-tight" style="max-width: 215mm; width: 100%; margin: 0 auto; background: #ffffff; padding: 15mm; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06); box-sizing: border-box;">
        ...
        <div class="flex justify-between items-start border-b-2 border-black pb-1">
            <div class="space-y-0.5">
                <table class="text-[9.5px] font-bold">
                    <tr>
        ...
        <!-- JUDUL FORMULIR DISDUKCAPIL PRESISI FIGMA (F.1-25) -->
        <div class="text-center py-0.5">
            <h1 class="text-xs font-black tracking-wider uppercase">
                FORMULIR PERMOHONAN PINDAH WNI
            </h1>
            <p class="text-[10.5px] font-extrabold tracking-tight">
                Antar Desa/Kelurahan Dalam Satu Kecamatan
            </p>
            <p class="text-[9.5px] font-bold tracking-tight text-slate-800">
        ...
        <div class="border border-black p-1.5 space-y-1">
            ...
            <table class="w-full text-[9.5px] leading-snug">
                <!-- 1. NO KK ASAL -->
                <tr>
                ...
                <tr>
                    ...
                    <td class="py-0.5">
                        <div class="space-y-0.5 w-full text-[9px]">
                            ...
                            <div class="grid grid-cols-2 gap-x-4 gap-y-0.5 w-full mt-0.5">
                                <!-- Kolom Kiri -->
                                <div class="space-y-0.5">
                                    <div class="flex items-center">
                            ...
                            <div class="grid grid-cols-2 gap-x-4 w-full mt-0.5">
                                ...
                                <div class="flex items-center font-bold">
                                    ...
                                    <span class="mr-1">:</span>
                                    <div class="flex-1 border border-black px-1.5 py-0.5 font-bold font-mono bg-white truncate">
                                        {{ $surat->telepon_asal ?? '-' }}
                                    </div>
                                </div>
                            </div>
        ...
        <div class="border border-black p-1.5 space-y-1">
            ...
            <table class="w-full text-[9.5px] leading-snug">
                ...
                <tr>
                    ...
                    <td>
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-0.5 text-[9px]">
                        ...
                        @if($surat->alasan_pindah_lainnya)
                            <div class="text-[8.5px] font-bold italic mt-0.5">Sebutkan: {{ $surat->alasan_pindah_lainnya }}</div>
                        @endif
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-0.5 text-[9px]">
        ...
        <div class="border border-black p-1.5 space-y-0.5">
            <div class="font-extrabold uppercase bg-slate-100 px-1.5 py-0.5 border-b border-black text-[9.5px]">
                6. KELUARGA YANG PINDAH
            </div>

            <table class="w-full text-left border-collapse border border-black text-[9px]">
                <thead>
                ...
                <tbody>
                    ...
                    @for($i = 0; $i < $totalRows; $i++)
                        ...
                        <tr class="border-b border-black">
                            ...
                            <td class="border border-black py-0.5 px-1 uppercase font-bold text-[8.5px]">
                                {{ $row['nama'] ?? '' }}
                            </td>
                            <td class="border border-black py-0.5 px-1 text-center font-semibold text-[8.5px]">
                                {{ $row['masa_berlaku_ktp'] ?? '' }}
                            </td>
                            <td class="border border-black py-0.5 px-1 text-center uppercase font-bold text-[8.5px]">
                                {{ $row['shdk'] ?? '' }}
                            </td>
                        </tr>
                    @endfor
        ...
        <!-- FOOTNOTE KETERANGAN PETUGAS -->
        <div class="text-[8.5px] text-slate-800 pt-1 border-t border-slate-300 font-bold" style="break-inside: avoid; page-break-inside: avoid;">
            <p>Keterangan:</p>
